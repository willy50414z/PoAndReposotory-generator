...
public class GeneratorConfig {
	...
	public boolean isGenerateAllTable() {
		return generateAllTable;
	}

	public void setGenerateAllTable(boolean generateAllTable) {
		this.generateAllTable = generateAllTable;
	}
	...
	public void setUseLombok(boolean isUseLombok) {
    ...
    private boolean generateAllTable;
